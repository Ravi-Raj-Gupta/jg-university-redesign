            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
               ...
               >
                  ...
                  <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                     Sponsored by the ASIA Charitable Trust, JG University aims
                     to bring excellence in everything it does. We stand by the
                     idea of knowledge beyond books and provide students a
